...
##LOAD NEW FILES
fft110 = np.load('C:\\Users\\mathiopv\\OneDrive - Charité - Universitätsmedizin Berlin\\FTG_PROJECT\\Subharmonics\\FFT_sub-021_ses-DbsFu12mMedOn01_task-Freq110Hz_acq-Streaming_run-01.npy')
fft125 = np.load('C:\\Users\\mathiopv\\OneDrive - Charité - Universitätsmedizin Berlin\\FTG_PROJECT\\Subharmonics\\FFT_sub-021_ses-DbsFu12mMedOn01_task-RampUpThres_acq-Streaming_run-01.npy')
fft145 = np.load('C:\\Users\\mathiopv\\OneDrive - Charité - Universitätsmedizin Berlin\\FTG_PROJECT\\Subharmonics\\FFT_sub-021_ses-DbsFu12mMedOn01_task-Freq145Hz_acq-Streaming_run-01.npy')

fig = plt.figure()
ax = [plt.subplot(1,3,i+1) for i in range(3)]
fig.suptitle('Sub021 - Subharmonics')
for a in ax[1:3]:
    a.set_yticklabels([])
for a in ax:  a.set_xlabel('Time [sec]')
#plt.subplots_adjust(wspace = 1, hspace = 0)

ax[0].pcolormesh(fft110[1,:,15:30], cmap = 'viridis', vmin = 0, vmax = 0.5)
ax[0].set_ylabel('Frequency [Hz]')
ax[0].set_title('3.4mA - 110Hz')
ax[1].pcolormesh(fft125[1,:,865:880], cmap = 'viridis', vmin = 0, vmax = 0.5)
ax[1].set_title('3.4mA - 125Hz')
ax[2].pcolormesh(fft145[1,:,225:240], cmap = 'viridis', vmin = 0, vmax = 0.5)
ax[2].set_title('3.4mA - 145Hz')
